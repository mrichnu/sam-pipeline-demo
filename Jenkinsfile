pipeline {
  ...
  environment {
    ...
    TESTING_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::187631333273:role/aws-sam-cli-managed-dev-p-CloudFormationExecutionR-KEFTMUU40NTY'
    TESTING_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-dev-pipeline-artifactsbucket-1h0bz0ephv6rk'
    ...
    PROD_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::187631333273:role/aws-sam-cli-managed-prod-pip-PipelineExecutionRole-M2TLGWJL3A4Q'
    PROD_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::187631333273:role/aws-sam-cli-managed-prod-CloudFormationExecutionR-5Y9ZTI7HG9OM'
    PROD_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-prod-pipeline-artifactsbucket-1nba6a80eocki'
    // If there are functions with "Image" PackageType in your template,
